...
const Employees = () => {
  ...
  useEffect(() => {
    const fetch = async () => {
      const data = await axios.get('https://employee-zfam.onrender.com/api/v1/user/getUsers', {
  ...
  const handleDelete = async (employeeId) => {
    try {
      const res = await axios.delete(`https://employee-zfam.onrender.com/api/v1/user/delete/${employeeId}`, {
        withCredentials: true,
      });
      if (res.data.message) {
        toast.success(res.data.message);
        const refreshed = await axios.get('https://employee-zfam.onrender.com/api/v1/user/getUsers', {
          withCredentials: true,
        });
  ...
  const handleLeave = async (employeeId) => {
    try {
      const res = await axios.get(`https://employee-zfam.onrender.com/api/v1/user/status/${employeeId}`, {
        withCredentials: true,
      });
      if (res.data.message) {
        navigate('/Employees');
  ...
  const handleActuve = async (employeeId) => {
    try {
      const res = await axios.get(`https://employee-zfam.onrender.com/api/v1/user/status/active/${employeeId}`, {
        withCredentials: true,
      });
      if (res.data.message) {
        navigate('/Employees');
