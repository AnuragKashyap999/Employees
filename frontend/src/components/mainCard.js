...
const MainCard = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const res = await axios.get("https://employees-cruv.onrender.com/api/v1/department/get", {
          withCredentials: true,
        });
        const res2 = await axios.get("https://employees-cruv.onrender.com/api/v1/user/getUsers", {
          withCredentials: true,
        });
